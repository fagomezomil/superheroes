  ...
  export default function SuperLogo() {
	return (
		<svg version="1.1"
		xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="71.4px" height="117.7px" viewBox="0 0 71.4 117.7" style="enable-background:new 0 0 71.4 117.7;">

		
		<g>
			<path className="fill-[#D30F00]" d="M29.8,24c0,0-5.9,10.1-12.4,15.2C10.9,44.3,5.9,52.3,3,60.3c-3,8-3,14.3-3,14.3s7.2-11.3,11.8-8
	...
	C56.6,25.8,29.8,24,29.8,24z"/>
			<path className="fill-[#FFFFFF]" d="M66.1,49.5C67,46,71.2,41.6,71.4,39c0.2-2.5-1.3-5.4-3.3-9.3c-1.4-2.8-4.1-5.1-5.1-5.7c-4.1-2.7-3.2-7-7.1-8.9
	...
	s4.1,0.8,6.2-2.4C67.3,53.5,65.2,53,66.1,49.5z"/>
			<path className="fill-[#D30F00]" d="M33.6,13c0,0,1.7,3.7,3.1,5.7c1.4,2,3.1,2.7,2.6,0c-0.5-2.5-0.9-7-0.9-7S35.5,9.5,33.6,13z" />
			<path className="fill-[#D30F00]" d="M47.7,12c0,0,1.1,3.8-0.9,6.5c-1.2,1.6-1.3,3.3,0.5,2.7c1.8-0.7,5.4-7.5,5.4-7.5S50.7,10.3,47.7,12z" />
			<path className="fill-[#FFFFFF]" d="M33.6,40.3c0,0,4,4,8.3,5.2c4.1,1.1,8.7,1,8.7,1l0.6,2.3c0,0-2.1,1.3-8.8,0c-6.7-1.3-10.6-5.9-10.6-5.9
	l1.3-1.7L33.6,40.3z"/>
			<path className="fill-[#FFFFFF]" d="M50.5,8.9c-0.3-0.4-0.6-0.4-0.8-0.3c0-0.5,0-1.5,0-2.9c0-2.2,0.2-3.3,0.4-4.2c-0.4,0.2-0.8,0.6-0.8,0.6
